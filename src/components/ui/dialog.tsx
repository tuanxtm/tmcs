  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'fixed top-1/2 left-1/2 z-50 flex w-[min(100%-2rem,24rem)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-y-auto overscroll-contain border border-border bg-popover bg-clip-padding text-xs/relaxed text-popover-foreground shadow-lg duration-200 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95',
          className,
        )}
        {...props}
      >
