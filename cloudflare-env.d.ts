/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: d1915222eaa97c3167a450efd3792676)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "DOShardedTagCache";
	}
	interface Env {
		R2: R2Bucket;
		...
		SEED_MANAGER_NAME: string;
		SEED_CREATOR_EMAIL: string;
		SEED_CREATOR_PASSWORD: string;
		SEED_CREATOR_NAME: string;
		NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace<import("./worker").DOShardedTagCache>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "NEXT_PUBLIC_SERVER_URL" | "CRON_SECRET" | "CONTACT_HASH_SECRET" | "SEED_ADMIN_EMAIL" | "SEED_ADMIN_PASSWORD" | "SEED_ADMIN_NAME" | "SEED_MANAGER_EMAIL" | "SEED_MANAGER_PASSWORD" | "SEED_MANAGER_NAME" | "SEED_CREATOR_EMAIL" | "SEED_CREATOR_PASSWORD" | "SEED_CREATOR_NAME">> {}
}
